...
.shopiva-bicycle-hero-media{position:absolute;inset:0;z-index:0;background:#071b31}
...
@media(max-width:760px){
  .shopiva-bicycle-hero{height:430px}
  .shopiva-bicycle-hero-media img{object-position:58% center}
  .shopiva-bicycle-hero-content{padding:34px 24px 52px;max-width:90%}
  .shopiva-bicycle-hero h1{font-size:clamp(34px,11vw,54px)}
  .shopiva-bicycle-hero p{font-size:13px}
}
</style>
'''
...
<section class="shopiva-bicycle-hero" aria-label="Shopiva Bicycle Spares">
  <div class="shopiva-bicycle-hero-media">
    <img src="__IMAGE__" alt="Shopiva bicycle hubs and spare parts">
  </div>
...
class ShopivaBrandingMiddleware:
    ...
    def __call__(self, request):
        ...
        response["Expires"] = "0"
        response["X-Shopiva-Bicycle-Hero"] = "approved-hub-image-v1"
        return response
